        ...
        <div class="content">
            <div class="right">
                <div class="header">
                    ...
                    <ul class="user-bar">
                        <li<?php if($okunmamis):?> class="active"<?php endif;?>><a href="#" data-open="#notif" onclick="read_notification()"><span class="fa fa-bell"></span><?php if($okunmamis): ?><span class="notification"><?=$okunmamis?></span><?php endif; ?></a>
