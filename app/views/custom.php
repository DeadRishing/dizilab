...
<div class="profile-edit-right">
                    <form action="" id="settings-form" onsubmit="return false;">
                        ...
                        <ul class="pedit-form">
                            <li><span class="title">E-posta</span><span class="form-value"><a class="edit-value" href="#"><span class="fa fa-pencil"></span></a><span class="value"><?=$me['user_mail']?><script cf-hash="f9e31" type="text/javascript">
/* <![CDATA[ */!function(){try{var t="currentScript"in document?document.currentScript:function(){for(var t=document.getElementsByTagName("script"),e=t.length;e--;)if(t[e].getAttribute("cf-hash"))return t[e]}();if(t&&t.previousSibling){var e,r,n,i,c=t.previousSibling,a=c.getAttribute("data-cfemail");if(a){for(e="",r=parseInt(a.substr(0,2),16),n=2;a.length-n;n+=2)i=parseInt(a.substr(n,2),16)^r,e+=String.fromCharCode(i);e=document.createTextNode(e),c.parentNode.replaceChild(e,c)}}}catch(u){}}();/* ]]> */</script></span><span class="description">E-posta adresini kimseyle paylaşmıyoruz, güvendesin!</span> </span>
                            ...
                            <li><span class="title">Hakkında</span><span class="form-value"><textarea name="uye_hakkinda" id="" cols="30" rows="10"><?=$me['user_info']?></textarea><span class="description">Kendin ve sevdiğin şeyleri yazarak insanlara kendini tanıtabilirsin.</span></span>
                            </li>
                        </ul>
                        <h3 class="title"><span class="none big-font">sosyal ağlarda sen</span></h3>
                        <ul class="pedit-form">
                            <li><span class="title"><span class="fa fa-facebook"></span> Facebook</span><span class="form-value"><input type="text" name="uye_facebook_url" style="width: 305px" value="<?=$me['user_fb']?>"><span class="description">İnsanların sana facebooktan ulaşmalarına ne dersin?</span></span>
                            </li>
                            <li><span class="title"><span class="fa fa-twitter"></span> Twitter</span><span class="form-value"><input type="text" name="uye_twitter_url" style="width: 305px" value="<?=$me['user_twttr']?>"><span class="description">Kuşlarımız ötmeye hazır! Peki sen buna hazır mısın?</span></span>
                            </li>
                ...
                <div class="profile-edit-left">
                    <div class="change-avatar">
                        <div>
                            ...
                            <form action="/request/php/" id="change-avatar" method="post" enctype="multipart/form-data"><img src="/upload/avatar/<?=$me['user_id']?>_avatar.png" class="user-avatar-bind" alt=""><a href="#" class="change-avatar-btn" style="bottom: 0; left: 0">Avatarını düzenle</a>
