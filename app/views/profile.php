<?php $this->load->view('header');?>
                <div class="dashboard-head">
                    <h1 class="username" style="padding-top: 17px"><?=$me['username']?> <span class="fa fa-star"></span></h1><img class="image" data-load-image="<?=avatar($me['user_id'])?>" src="<?=img_loader()?>" alt="">
                    <div class="alt">
                        <ul>
