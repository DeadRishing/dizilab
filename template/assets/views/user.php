<?$this->load->view('header');?>
				<div class="dashboard-head">
                    ...
                    <h1 class="username"><?=$user['username']?>&nbsp;<span class="fa fa-<?if($user['gender']=='m'){echo'male';}else{echo'female';}?>" style="font-size: 22px; color: #373F42;"></span><?if(isset($me['login'])):?><?=uye_takip($me['user_id'],$user['usaid'],$takipcim)?><?endif;?></h1>
